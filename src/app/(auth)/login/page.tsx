...
export default function Page() {
  return (
    <div className="flex h-screen w-full items-center justify-between overflow-hidden bg-white p-32">
      <div className="h-full min-w-0 flex-[1_0_0]">
        <LoginCarousel />
      </div>

      <div className="flex h-full w-520 shrink-0 items-center justify-center">
