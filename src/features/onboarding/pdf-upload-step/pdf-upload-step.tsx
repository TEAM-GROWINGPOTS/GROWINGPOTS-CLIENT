...
import { UploadedFileCard } from '../uploaded-file-card/uploaded-file-card';
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-12">
        ...
        {file && <UploadedFileCard fileName={file.name} fileSizeBytes={file.size} onRemove={() => setFile(null)} />}
      </div>
